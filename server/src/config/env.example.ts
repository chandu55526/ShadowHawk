export const env = {
  ...
  STRICT_RATE_LIMIT_WINDOW_MS: parseInt(
    process.env.STRICT_RATE_LIMIT_WINDOW_MS || "3600000",
    10,
  ), // 1 hour
  STRICT_RATE_LIMIT_MAX_REQUESTS: parseInt(
    process.env.STRICT_RATE_LIMIT_MAX_REQUESTS || "5",
    10,
  ),
